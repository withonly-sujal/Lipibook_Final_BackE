...
function UserManage2() {
  ...
  // 📁 Static subfolders (upload removed)
  ...
  const handleFolderClick = (folder) => {
    router.push(
      `/UserLogin/User-FolderView?folder=${encodeURIComponent(folder.name)}`
    );
  };
...
export default UserManage2Wrapper;
